// Autogenerated from development/constructs/constraint_pass.i
...
public enum constraint_pass implements deeply_immutable_data, stringable {
  ASSERT_CONSTRAINT(new base_string("assert")),
  VERIFY_CONSTRAINT(new base_string("verify"));
  private final string name_string;
  private constraint_pass(final string name_string) {
