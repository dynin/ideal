...
public class test_doc_grammar {
  ...
  public void test_simple_parse() {
    ...
    assert ((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("  <html>foo</html>  "));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("  <html  >foo</html  >  "));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("  <html  >Hello &amp; goodbye!</html  >  "));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("  <html  />  "));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("<html/>"));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("  <html>Hello <em>world!</em></html>  "));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("  <html><body ><p>Hello <em >world!</em ></p></body ></html>  "));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("  <html><body > <p>Hello<br />world!</p> </body ></html>  "));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("  <html><body > Hello &lt;world!&gt; </body ></html>  "));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("<html><p class=\'klass\'>foo</p></html>"));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("<html><a class = \'klass\' href = \'link\'>bar</a></html>"));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("<html><p class = \'value\">==\' attr=\"foo\'\">foo</p></html>"));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("<html><p class = \'***\' attr=\"baz\">foo</p></html>"));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string(" no markup "));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("  &amp;<html>foo</html>  "));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("  <html>foo  "));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("  <html>foo<bar>  "));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("  <>foo  "));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("<html><p class=\'klass\">foo</p></html>"));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("<html><p class=\'klass\'>foo</p class=\"foo\"></html>"));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("<html foo= ><p class=\'klass\'>foo</p></html>"));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("<html foo=bar><p class=\'klass\'>foo</p></html>"));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("  foo| unmatched  "));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) content_matcher).call(new base_string("  <abc>foo</def>  "));
