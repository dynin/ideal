...
public class create_flags implements value {
  ...
  public final boolean SLOW_MODE;
  ...
  public create_flags(final readonly_list<string> arguments, final procedure1<Void, string> error_reporter) {
    ...
    this.SLOW_MODE = ideal.runtime.flags.flags_utilities.boolean_flag(arg_dictionary, new ideal.runtime.elements.base_string("SLOW_MODE"));
