...
public class flavor {
  ...
  public final static type_flavor readonly_flavor = new type_flavor_impl(new base_string("readonly"), flavor_profiles.mutable_profile, new base_list<type_flavor>(any_flavor));
  public final static type_flavor writeonly_flavor = new type_flavor_impl(new base_string("writeonly"), flavor_profiles.mutable_profile, new base_list<type_flavor>(any_flavor));
  ...
  public final static type_flavor immutable_flavor = new type_flavor_impl(new base_string("immutable"), flavor_profiles.immutable_profile, new base_list<type_flavor>(readonly_flavor));
  public final static type_flavor deeply_immutable_flavor = new type_flavor_impl(new base_string("deeply_immutable"), flavor_profiles.deeply_immutable_profile, new base_list<type_flavor>(immutable_flavor));
