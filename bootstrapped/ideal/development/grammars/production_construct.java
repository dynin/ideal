...
public class production_construct extends base_construct implements stringable {
  ...
  public production_construct(final simple_name the_name, final readonly_list<readonly_list<term_construct>> term_lists, final origin generated_origin) {
  ...
  public @Override readonly_list<construct> children() {
    ...
    generated_result.append_all((readonly_list<construct>) (Object) this.term_lists);
