...
public class punctuation {
  public static final punctuation_type SINGLE_QUOTE = new punctuation_type(new base_string("'"));
  public static final punctuation_type DOUBLE_QUOTE = new punctuation_type(new base_string("\""));
