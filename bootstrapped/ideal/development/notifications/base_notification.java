...
public class base_notification implements notification {
  ...
  public @Override text_fragment render_text(final boolean prefix_with_source) {
    ...
    final text_fragment primary = text_utilities.join(new base_element(text_library.DIV, text_library.CLASS, MESSAGE_CLASS, full_message), origin_printer.show_origin(this.the_origin));
