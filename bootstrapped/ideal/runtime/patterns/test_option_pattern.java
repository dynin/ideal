...
public class test_option_pattern implements value {
  ...
  public void test_match_prefix() {
    ...
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern.match_prefix(new base_string("abbc")), 3);
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern.match_prefix(new base_string("bcdef")), 2);
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern.match_prefix(new base_string("aAbBcCdef")), 4);
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern.match_prefix(new base_string("bCabc")), 2);
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern.match_prefix(new base_string("aaabbbcccddd")), 6);
  }
  public void test_find_first() {
    ...
    assert ideal.machine.elements.runtime_util.values_equal(match.end(), 6);
    ...
    assert match3 != null;
    assert ideal.machine.elements.runtime_util.values_equal(match3.begin(), 6);
    assert ideal.machine.elements.runtime_util.values_equal(match3.end(), 9);
    final @Nullable range match4 = the_pattern.find_first(new base_string("fooACxyzABC"), 0);
    assert match4 != null;
    assert ideal.machine.elements.runtime_util.values_equal(match4.begin(), 3);
    assert ideal.machine.elements.runtime_util.values_equal(match4.end(), 4);
    final @Nullable range match5 = the_pattern.find_first(new base_string("aaabbbAAACCCBBB"), 9);
    assert match5 != null;
    assert ideal.machine.elements.runtime_util.values_equal(match5.begin(), 9);
    assert ideal.machine.elements.runtime_util.values_equal(match5.end(), 12);
  }
  ...
  public void run_all_tests() {
    ideal.machine.elements.runtime_util.start_test(new base_string("test_option_pattern.test_match"));
    this.test_match();
    ideal.machine.elements.runtime_util.end_test();
    ideal.machine.elements.runtime_util.start_test(new base_string("test_option_pattern.test_viable_prefix"));
    this.test_viable_prefix();
    ideal.machine.elements.runtime_util.end_test();
    ideal.machine.elements.runtime_util.start_test(new base_string("test_option_pattern.test_match_prefix"));
    this.test_match_prefix();
    ideal.machine.elements.runtime_util.end_test();
    ideal.machine.elements.runtime_util.start_test(new base_string("test_option_pattern.test_find_first"));
    this.test_find_first();
    ideal.machine.elements.runtime_util.end_test();
    ideal.machine.elements.runtime_util.start_test(new base_string("test_option_pattern.test_split"));
    this.test_split();
    ideal.machine.elements.runtime_util.end_test();
  }
}
