...
public class test_repeat_pattern implements value {
  ...
  public void test_match_prefix() {
    ...
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern.match_prefix(new base_string("abcacaxyz")), 5);
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern.match_prefix(new base_string("ACACABCfoo")), 7);
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern.match_prefix(new base_string("ACfoo")), 2);
    final repeat_pattern<Character> the_pattern2 = this.make_pattern(true);
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern2.match_prefix(new base_string("")), 0);
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern2.match_prefix(new base_string("a")), 0);
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern2.match_prefix(new base_string("ab")), 0);
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern2.match_prefix(new base_string("x")), 0);
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern2.match_prefix(new base_string("xabc")), 0);
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern2.match_prefix(new base_string("abc")), 3);
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern2.match_prefix(new base_string("abcdef")), 3);
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern2.match_prefix(new base_string("aAbBcCdef")), 6);
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern2.match_prefix(new base_string("aAbCdef")), 4);
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern2.match_prefix(new base_string("aaabbbcccddd")), 9);
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern2.match_prefix(new base_string("abcacaxyz")), 5);
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern2.match_prefix(new base_string("ACACABCfoo")), 7);
    assert ideal.machine.elements.runtime_util.values_equal(the_pattern2.match_prefix(new base_string("ACfoo")), 2);
  }
  public void test_find_first() {
    ...
    assert match2 != null;
    assert ideal.machine.elements.runtime_util.values_equal(match2.begin(), 2);
    assert ideal.machine.elements.runtime_util.values_equal(match2.end(), 15);
    ...
    assert match4 != null;
    assert ideal.machine.elements.runtime_util.values_equal(match4.begin(), 9);
    assert ideal.machine.elements.runtime_util.values_equal(match4.end(), 15);
  }
