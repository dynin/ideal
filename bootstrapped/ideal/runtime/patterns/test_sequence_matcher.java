...
public class test_sequence_matcher implements value {
  ...
  public void test_match_parse() {
    final list<pattern<Character>> patterns_list = new base_list<pattern<Character>>(((pattern<Character>) (Object) this.make_matcher(new function1<Boolean, Character>() {
      public @Override Boolean call(Character first) {
        return test_sequence_matcher.this.match_a(first);
      }
    })), ((pattern<Character>) (Object) this.make_matcher(new function1<Boolean, Character>() {
      public @Override Boolean call(Character first) {
    ...
    assert ((sequence_pattern<Character>) (Object) the_matcher).call(new base_string("abc"));
    assert ((sequence_pattern<Character>) (Object) the_matcher).call(new base_string("AbC"));
    assert ((sequence_pattern<Character>) (Object) the_matcher).call(new base_string("AaaBbCcc"));
    assert ((sequence_pattern<Character>) (Object) the_matcher).call(new base_string("AaaBBBCcc"));
    assert !((sequence_pattern<Character>) (Object) the_matcher).call(new base_string("bac"));
    assert !((sequence_pattern<Character>) (Object) the_matcher).call(new base_string("aabb"));
    assert !((sequence_pattern<Character>) (Object) the_matcher).call(new base_string("aaca"));
  ...
  public void run_all_tests() {
    ideal.machine.elements.runtime_util.start_test(new base_string("test_sequence_matcher.test_match_parse"));
