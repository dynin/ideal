...
public class test_sequence_pattern implements value {
  ...
  public test_sequence_pattern() { }
  public void run_all_tests() {
    ideal.machine.elements.runtime_util.start_test(new base_string("test_sequence_pattern.test_match"));
    this.test_match();
    ideal.machine.elements.runtime_util.end_test();
    ideal.machine.elements.runtime_util.start_test(new base_string("test_sequence_pattern.test_viable_prefix"));
    this.test_viable_prefix();
    ideal.machine.elements.runtime_util.end_test();
    ideal.machine.elements.runtime_util.start_test(new base_string("test_sequence_pattern.test_match_prefix"));
    this.test_match_prefix();
    ideal.machine.elements.runtime_util.end_test();
    ideal.machine.elements.runtime_util.start_test(new base_string("test_sequence_pattern.test_find_first"));
    this.test_find_first();
    ideal.machine.elements.runtime_util.end_test();
    ideal.machine.elements.runtime_util.start_test(new base_string("test_sequence_pattern.test_find_first_more"));
    this.test_find_first_more();
    ideal.machine.elements.runtime_util.end_test();
    ideal.machine.elements.runtime_util.start_test(new base_string("test_sequence_pattern.test_split"));
    this.test_split();
    ideal.machine.elements.runtime_util.end_test();
  }
}
