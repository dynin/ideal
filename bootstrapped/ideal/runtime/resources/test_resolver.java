// Autogenerated from isource/runtime/resources/test_resolver.i
...
public class test_resolver {
  ...
  public void test_sub_catalogs() {
    ...
    final resource_catalog cat2 = dog.access_catalog().content().get();
  ...
  public void test_multiple_subdirs() {
    ...
    foo = bar.access_catalog().content().get();
