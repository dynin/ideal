...
public class test_markup_grammar implements value {
  ...
  public void test_entity_ref() {
    ...
    assert ((function1<Boolean, readonly_list<Character>>) (Object) entity_ref).call(new base_string("&lt;"));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) entity_ref).call(new base_string("&amp;"));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) entity_ref).call(new base_string("&bull;"));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) entity_ref).call(new base_string("foo"));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) entity_ref).call(new base_string("&foo"));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) entity_ref).call(new base_string("foo;"));
  ...
  public void test_attribute() {
    ...
    assert ((function1<Boolean, readonly_list<Character>>) (Object) attribute).call(new base_string("id = \'68\'"));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) attribute).call(new base_string("href = \"https://theideal.org/\""));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) attribute).call(new base_string("clear=\'all\'"));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) attribute).call(new base_string("<html>"));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) attribute).call(new base_string("foo"));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) attribute).call(new base_string("bar ="));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) attribute).call(new base_string("&lt;name&gt; = \'value\'"));
  ...
  public void test_empty_element() {
    ...
    assert ((function1<Boolean, readonly_list<Character>>) (Object) empty_element).call(new base_string("<html/>"));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) empty_element).call(new base_string("<body class=\"foo\" />"));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) empty_element).call(new base_string("<html>"));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) empty_element).call(new base_string("bar"));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) empty_element).call(new base_string("&lt;html&gt;"));
    ...
    assert ((readonly_collection<dictionary.entry<attribute_id, attribute_fragment>>) (Object) element0.attributes()).is_empty();
    ...
    assert ideal.machine.elements.runtime_util.values_equal(((readonly_collection<dictionary.entry<attribute_id, attribute_fragment>>) (Object) element1.attributes()).size(), 1);
    assert ((readonly_collection<dictionary.entry<attribute_id, attribute_fragment>>) (Object) element1.attributes()).elements().get(0).key() == text_library.CLASS;
    assert ideal.machine.elements.runtime_util.values_equal(((readonly_collection<dictionary.entry<attribute_id, attribute_fragment>>) (Object) element1.attributes()).elements().get(0).value(), new base_string("foo"));
    ...
    assert ideal.machine.elements.runtime_util.values_equal(((readonly_collection<dictionary.entry<attribute_id, attribute_fragment>>) (Object) element2.attributes()).size(), 2);
    final immutable_list<dictionary.entry<attribute_id, attribute_fragment>> attributes = ((readonly_collection<dictionary.entry<attribute_id, attribute_fragment>>) (Object) element2.attributes()).elements();
  ...
  public void test_content() {
    ...
    assert ((function1<Boolean, readonly_list<Character>>) (Object) content).call(new base_string("  hello, world!"));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) content).call(new base_string("&lt;html&gt;"));
  ...
  public void test_simple_parse() {
    ...
    assert ((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("  <html>foo</html>  "));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("  <html  >foo</html  >  "));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("  <html  >Hello &amp; goodbye!</html  >  "));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("  <html  />  "));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("<html/>"));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("  <html>Hello <em>world!</em></html>  "));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("  <html><body ><p>Hello <em >world!</em ></p></body ></html>  "));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("  <html><body > <p>Hello<br />world!</p> </body ></html>  "));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("  <html><body > Hello &lt;world!&gt; </body ></html>  "));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("<html><p class=\'klass\'>foo</p></html>"));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("<html><a class = \'klass\' href = \'link\'>bar</a></html>"));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("<html><p class = \'value\">==\' attr=\"foo\'\">foo</p></html>"));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("<html><p class = \'***\' attr=\"baz\">foo</p></html>"));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string(" no markup "));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("  <html>foo  "));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("  <html>foo<bar>  "));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("  <>foo  "));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("  &amp;<html>foo</html>  "));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("<html><p class=\'klass\">foo</p></html>"));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("<html><p class=\'klass\'>foo</p class=\"foo\"></html>"));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("<html foo= ><p class=\'klass\'>foo</p></html>"));
    assert !((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("<html foo=bar><p class=\'klass\'>foo</p></html>"));
    assert ((function1<Boolean, readonly_list<Character>>) (Object) document_matcher).call(new base_string("  <abc>foo</def>  "));
