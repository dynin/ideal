...
public class test_plain_text {
  ...
  public static final string WYZZY = new base_string("wyzzy");
  ...
  public void test_underline_tag() {
    final string_writer the_writer = new string_writer();
    final plain_formatter the_formatter = new plain_formatter(the_writer);
    the_formatter.write(new base_string("hello "));
    final string world_string = new base_string("world");
  ...
  public void test_two_underlines() {
    final string_writer the_writer = new string_writer();
    final plain_formatter the_formatter = new plain_formatter(the_writer);
    final text_element hi = new base_element(text_library.U, new base_string("hi"));
    final text_element mid = new base_element(text_library.U2, new list_dictionary<attribute_id, attribute_fragment>(), base_list_text_node.make(new base_string("start "), hi, new base_string(" end")));
    the_formatter.write(text_utilities.join(new base_string("foo "), mid, new base_string(" bar")));
    the_formatter.write(new base_element(text_library.BR, null));
  ...
  public void test_blank_line() {
    ...
    the_formatter.write(new base_element(text_library.DIV, new base_string("bar")));
    assert ideal.machine.elements.runtime_util.values_equal(new base_string("foo\n\nbar\n"), the_writer.elements());
  }
