...
Or using the the run script directly:
...
2. **Hexagram Database**: Complete set of all 64 hexagrams
   - Authentic traditional meanings
   - Accessible guidance for modern readers

3. **Reading Function**: Orchestrates the three-hexagram casting
...
void perform_reading()                    -- Perform complete reading
